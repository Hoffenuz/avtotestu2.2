...
export default function MavzuliTestlar() {
  ...
  useEffect(() => {
    if (!isLoading && !user) {
      navigate('/auth', { state: { returnTo: '/mavzuli-testlar' } });
    }
  ...
  return (
    <MainLayout>
      <SEOHead
        ...
        description="Yo'l harakati qoidalari bo'yicha mavzuli testlar. Har bir mavzu bo'yicha alohida testlar. Haydovchilik imtihoniga tayyorlanish."
        keywords="mavzuli test, YHQ mavzular, yo'l belgilari test, svetafor test, haydovchilik mavzuli test"
        canonicalUrl="/mavzuli"
      />
