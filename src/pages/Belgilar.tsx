...
export default function Belgilar() {
  ...
  return (
    <MainLayout>
      <SEOHead
        title="Yo'l belgilari 2025"
        description="O'zbekiston yo'l belgilari to'liq ro'yxati 2025. Ogohlantiruvchi, taqiqlovchi, axborot belgilari va boshqalar. Haydovchilik imtihoniga tayyorlanish uchun."
        keywords="yo'l belgilari, yo'l belgilari 2025, ogohlantiruvchi belgilar, taqiqlovchi belgilar, axborot belgilari, YHQ belgilar"
        canonicalUrl="/belgilar"
      />
      {/* Hero Section */}
