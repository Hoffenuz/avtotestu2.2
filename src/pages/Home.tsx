...
export default function Home() {
  ...
  return (
    <MainLayout>
      <SEOHead
        title="Bosh sahifa"
        description="O'zbekistonda haydovchilik guvohnomasi olish uchun onlayn test platformasi. 1100+ savol, yo'l belgilari, variantlar. Bepul YHQ testlari 2025."
        keywords="haydovchilik test, YHQ test, yo'l belgilari, avtotest, haydovchilik imtihoni, prava test, avtomaktab test"
        canonicalUrl="/"
      />
