...
export default function Pro() {
  ...
  return (
    <MainLayout>
      <SEOHead
        title="Pro obuna"
        description="AvtoTest Pro obunasi. 55+ variant, barcha mavzular, reklama yo'q. Haydovchilik imtihoniga eng yaxshi tayyorgarlik."
        keywords="avtotest pro, haydovchilik test obuna, yhq premium, prava test obuna"
        canonicalUrl="/pro"
      />
